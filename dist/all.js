	  ...
	  function initArrayCopyWatch() {
	    ...
	    service.events.push(service.scope.$on('schemaFormDeleteScope', function (event, scope, index) {
	      ...
	      if (scope.form.link) {
	        ...
	        var copyGroups = service.getArrayCopiesFor(scope.form.link);
	        _.each(copyGroups, function (group) {
	          return _.each(group, function (scope) {
