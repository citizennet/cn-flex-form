	...
	function CNFlexFormService(Api, $parse, cnFlexFormConfig, cnFlexFormTypes, sfPath, $interpolate, $rootScope, $timeout, cnUtil, $stateParams) {
	  ...
	  function processDefault(field) {
	    ...
	    if (!_.isUndefined(curDefault)) {
	      ...
	      if ((_.isTrulyEmpty(modelValue) && !service.updates || _.has(service.defaults, key) && angular.equals(modelValue, service.defaults[key])) && !angular.equals(modelValue, curDefault)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function FlexForm(cnFlexFormService, $scope, $location) {
	  ...
	  vm.cleanup = function (e_) {
	    console.log(':: before ::', _.cloneDeep(vm.service));
	    cnFlexFormService.destroyService(vm.service);
	    console.log(':: after ::', _.cloneDeep(vm.service));
	    // cleanup();
	  };
	  ...
	  function showForm() {
	    // console.log(':: form ::', vm.formIndex)
	    // console.log(':: delatForm ::', vm.delayForm);
	    // console.log(':: isCompiled ::', vm.service && vm.service.isCompiled());
