	      ...
	      if (watch.resolution) {
	        ...
	        if (_.isFunction(resolution)) {
	          ...
	          handler = function handler(val, prev, key, trigger, customizationIndex) {
	            var curCondition = condition && replaceArrayIndex(condition, key, customizationIndex, field.type);
	            ...
	            var updatePath = replaceArrayIndex(resolution[1], key, customizationIndex, field.type);
	            var fromPath = replaceArrayIndex(resolution[2], key, customizationIndex, field.type);
